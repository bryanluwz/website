...
export const Footer: React.FC = () => {
  ...
  return (
    <Grid2 container spacing={2} className={styles.container}>
      <Grid2 size={2.5} />
      <Grid2 size={4.5} direction="column">
      ...
      <Grid2 size={2} direction="column">
        <Stack direction="column" spacing={2}>
          ...
          <Stack direction="column" spacing={1}>
            ...
            <Link className={styles.link} href="https://github.com/bryanluwz">
            ...
            <Link className={styles.link} href="mailto:bryanlu.my@gmail.com">
